...
cd /root/mapr-repo && wget -r -l1 -A.rpm 'http://package.mapr.com/releases/v4.0.2/redhat/'
...
'0.13')
    ...
    cd /root/mapr-repo && wget 'http://package.mapr.com/releases/ecosystem-4.x/redhat/mapr-hive-0.13.201503021511-1.noarch.rpm'
    cd /root/mapr-repo && wget 'http://package.mapr.com/releases/ecosystem-4.x/redhat/mapr-hivemetastore-0.13.201503021511-1.noarch.rpm'
    cd /root/mapr-repo && wget 'http://package.mapr.com/releases/ecosystem-4.x/redhat/mapr-hiveserver2-0.13.201503021511-1.noarch.rpm'
;;
esac
